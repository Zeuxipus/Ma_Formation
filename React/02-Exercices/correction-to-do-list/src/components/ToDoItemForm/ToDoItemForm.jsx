...
const ToDoItemForm = (props) => {
    ...
    const formSubmitHandler = (e) => {
        e.preventDefault()
        props.onAddTodo(new TodoItem(props.todoId, titleRef.current.value, descriptionRef.current.value, new Date(dueDateRef.current.value.split("/").reverse().join("-"))))
        ...
        <div>
            ...
            <form onSubmit={formSubmitHandler}>
                ...
                <div className='mb-3'>
                    ...
                    <textarea type="text" id='description' className='form-control'  ref={descriptionRef} cols={30} rows={10}required/>
                </div>
